...
public class Konfigurasi {
    ...
    public static final String URL_GET_MHS = "http://192.168.1.5/db_android/select.php?id=";
    public static final String URL_UPDATE_MHS = "http://192.168.1.5/db_android/update.php";
    public static final String URL_DELETE_MHS = "http://192.168.1.5/db_android/delete.php?id=";
